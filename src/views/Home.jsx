...
// Swap these in once you have the real photos
// import sunPhoto1 from "../assets/pictures/sun1.jpg"
// import sunPhoto2 from "../assets/pictures/sun2.jpg"
// import sunPhoto3 from "../assets/pictures/sun3.jpg"
// import sunPhoto4 from "../assets/pictures/sun4.jpg"
...
function Home() {
  ...
  const newCount = useMemo(
    () => notices.filter(n => isNew(n.createdAt)).length,
    [notices]
  )

  // Triple the flags so the seamless loop has plenty of runway
          ...
          <div className="noticeBoardHeader">
            <div className="noticeBoardTitleRow">
              ...
              <div className="noticeBoardMeta">
                {newCount > 0 && (
                  <span className="noticeBoardNewCount">{newCount} new</span>
                )}
                {!loading && (
                  <span className="noticeBoardTotal">{notices.length} notices</span>
                )}
              </div>
            </div>
